...
from model2 import answer_query_model2, answer_amenities_question, answer_club_question, answer_degree_question, answer_event_question, answer_sport_question
...
def chatbot():
    ...
    # Format the answer using OpenAI
    formatted_answer = format_answer_with_openai(base_answer)
    ...
    return jsonify({'base_answer': base_answer, 'formatted_answer': formatted_answer})
